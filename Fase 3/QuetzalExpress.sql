...
SELECT casilla AS 'Casilla', nombre AS 'Nombre', apellido AS 'Apellido', telefono AS 'Teléfono', correo AS 'Correo' FROM CLIENTE WHERE casilla LIKE '%r%' OR nombre LIKE '%r%' OR apellido LIKE '%r%' OR telefono LIKE '%r%' OR correo LIKE '%r%'

SELECT id AS 'ID', nombre AS 'Nombre', apellido AS 'Apellido', sueldo AS 'Sueldo', sucursal AS 'Sucursal', departamento AS 'Departamento', tipo FROM EMPLEADO WHERE sucursal = 01 AND departamento = 'Servicio al cliente'

INSERT INTO ESTADO VALUES (5, GETDATE(), 'En bodega')
